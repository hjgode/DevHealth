    ...
    public class SSAPIwrapper : IDisposable
    {
        ...
        public void Dispose()
        {
            if (hEvent != IntPtr.Zero)
                SSAPIwrapper.CloseHandle(this.hEvent);
        ...
        public string getBattInfo(ref uint uError)
        {
            ...
            {
                this.hEvent = SSAPIwrapper.CreateEvent(IntPtr.Zero, true, false, "SS_HEALTH_GUI_ACCESS");
            }
            #region batteryProps
            string[] sBattProp = { 
                        "BackupBatteryFlag",
            ...
            if (this.hEvent != IntPtr.Zero)
            {
                bool b1 = SSAPIwrapper.EventModify(this.hEvent, 3);
                uInt32_1 = this.SSAPI.Get(string1, ref stringBuilder1);
                bool b2 = SSAPIwrapper.EventModify(this.hEvent, 2);
                bool b3 = SSAPIwrapper.CloseHandle(this.hEvent);
            }
        ...
        public string getHealthInfo(string s, ref uint uError)
        {
            ...
            else
            {
                ...
                uiRet = uint.Parse(sErr, System.Globalization.NumberStyles.AllowHexSpecifier);
                string sErrHex=uiRet.ToString("X8");
                System.Diagnostics.Debug.WriteLine(sErrHex + "\r\n" + stringBuilder1);
                string sErrText=DevHealth.SSerrorStrings.getErrorString("0x" + sErrHex);
                System.Diagnostics.Debug.WriteLine(DevHealth.SSerrorStrings.getErrorString("0x" + sErrHex));
                System.Diagnostics.Debug.WriteLine(DevHealth.SSAPIerrors.getErrString(uiRet));
                uError = uiRet;
                sRet = sErrHex + ":" + sErrText;
            }
        ...
        Dictionary<String, String> HealthData
        {
            get
            {
